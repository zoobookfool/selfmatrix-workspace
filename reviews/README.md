...
| 日付 | ファイル | 対象 | 結論 / 状態 |
| --- | --- | --- | --- |
| 2026-07-13 | [dogfooding-native-20260713.md](dogfooding-native-20260713.md) | native アプリ実使用フィードバック (運用者、本番サーバー実使用) | 9 所見を triage。④ Electron メニューと⑧単独 deafen は `selfmatrix-desktop` `ec5c207` で対応済み。⑤⑦は再現切り分け待ち。残り6項目を backlog で追跡 |
