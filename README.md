...
- [native-client-rethink.md](native-client-rethink.md) — クライアントのネイティブアプリ化 (要件再定義の検討ドラフト)
- [call-window-mode.md](call-window-mode.md) — 別ウィンドウ通話開始モードの設計検討 (ドラフト)
