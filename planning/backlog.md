...
| P2 | 後追い参加時に過去の通話参加/終了イベントが洪水 | ドッグフーディング検出 (2026-07-13、web共通)。GPT対応予定。RoomTimeline.tsx でコールイベントの集約が無い。設計参照モックあり (目標=案A 通話カード、最小着地=案B 折りたたみ) | [dogfooding-native-20260713.md](../reviews/dogfooding-native-20260713.md) ②, [call-event-aggregation-mock.html](../design/mocks/call-event-aggregation-mock.html) | 連続する通話参加/終了イベントが折りたたまれ、履歴で洪水にならない |
